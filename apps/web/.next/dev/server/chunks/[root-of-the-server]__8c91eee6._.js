...
"[project]/apps/web/app/api/v1/users/profile/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(req) {
    try {
        ...
        const result = await __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$lib$2f$services$2f$users$2e$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["usersService"].getProfile(user.id);
...
async function PUT(req) {
    try {
        ...
        const result = await __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$lib$2f$services$2f$users$2e$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["usersService"].updateProfile(user.id, data);
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(result);
    } catch (error) {
        console.error("❌ [USERS] Error:", error);
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
...
//# sourceMappingURL=%5Broot-of-the-server%5D__8c91eee6._.js.map
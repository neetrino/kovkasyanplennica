...
"[project]/apps/web/app/api/v1/admin/orders/[id]/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(req, { params }) {
    try {
        ...
        const order = await __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$lib$2f$services$2f$admin$2e$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["adminService"].getOrderById(id);
...
async function PUT(req, { params }) {
    try {
        ...
        console.log("📤 [ADMIN ORDERS] PUT request:", {
            id,
            body
        });
        const order = await __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$lib$2f$services$2f$admin$2e$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["adminService"].updateOrder(id, body);
...
async function DELETE(req, { params }) {
    ...
    try {
        ...
        await __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$lib$2f$services$2f$admin$2e$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["adminService"].deleteOrder(orderId);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__51a9812e._.js.map
...
"[project]/apps/web/lib/services/reviews.service.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
class ReviewsService {
   ...
   */ async getProductReviews(productId, options) {
        ...
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$lib$2f$utils$2f$db$2d$ensure$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["ensureProductReviewsTable"])();
        ...
        const reviews = await __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$db$2f$client$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].productReview.findMany({
            where,
            include: {
                user: {
                    select: {
        ...
        return reviews.map((review)=>({
                ...
                userName: review.user.firstName && review.user.lastName ? `${review.user.firstName} ${review.user.lastName}` : review.user.firstName || review.user.lastName || review.user.email || 'Anonymous',
   ...
   */ async getUserReview(productId, userId, includeUnpublished = true) {
        // Ensure table exists before querying
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$lib$2f$utils$2f$db$2d$ensure$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["ensureProductReviewsTable"])();
        console.log('📝 [REVIEWS SERVICE] Getting user review:', {
            productId,
            userId
        });
        const review = await __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$db$2f$client$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].productReview.findUnique({
            where: {
                productId_userId: {
                    productId,
                    userId
   ...
   */ async createReview(productId, userId, data) {
        ...
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$lib$2f$utils$2f$db$2d$ensure$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["ensureProductReviewsTable"])();
        console.log('📝 [REVIEWS SERVICE] Creating review:', {
            productId,
            userId,
            rating: data.rating
        });
        ...
        const existingReview = await __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$db$2f$client$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].productReview.findUnique({
            where: {
                productId_userId: {
                    productId,
                    userId
        ...
        // Create review
        const review = await __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$db$2f$client$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].productReview.create({
            data: {
                productId,
                userId,
                rating: data.rating,
   ...
   */ async updateReview(reviewId, userId, data) {
        ...
        // Update review
        const updated = await __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$db$2f$client$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].productReview.update({
            where: {
                id: reviewId
            },
            data: {
        ...
        return {
            ...
            userName: updated.user.firstName && updated.user.lastName ? `${updated.user.firstName} ${updated.user.lastName}` : updated.user.firstName || updated.user.lastName || updated.user.email || 'Anonymous',
   ...
   */ async deleteReview(reviewId, userId) {
        ...
        await __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$db$2f$client$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].productReview.delete({
            where: {
                id: reviewId
            }
        });
...
class AdminService {
   ...
   */ async updateProductDiscount(productId, discountPercent) {
        console.log('💰 [ADMIN SERVICE] updateProductDiscount called:', {
            productId,
            discountPercent
        });
        const product = await __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$db$2f$client$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].product.findUnique({
   ...
   */ async updateAttributeTranslation(attributeId, data) {
        console.log('✏️ [ADMIN SERVICE] Updating attribute translation:', {
            attributeId,
            name: data.name
        });
        const attribute = await __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$db$2f$client$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].attribute.findUnique({
   ...
   */ async addAttributeValue(attributeId, data) {
        console.log('➕ [ADMIN SERVICE] Adding attribute value:', {
            attributeId,
            label: data.label
        });
        const attribute = await __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$db$2f$client$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].attribute.findUnique({
   ...
   */ async updateAttributeValue(attributeId, valueId, data) {
        console.log('✏️ [ADMIN SERVICE] Updating attribute value:', {
            attributeId,
            valueId,
            data
        });
...
class ProductsService {
   ...
   */ async findAll(filters) {
        const { category, search, filter, minPrice, maxPrice, colors, sizes, brand, sort = "createdAt", page = 1, limit = 24, lang = "en" } = filters;
        const skip = (page - 1) * limit;
        ...
        // Add category filter
        if (category) {
            console.log('🔍 [PRODUCTS SERVICE] Looking for category:', {
                category,
                lang
            });
            ...
            if (!categoryDoc) {
                console.warn('⚠️ [PRODUCTS SERVICE] Category not found in language:', {
                    category,
                    lang
                });
            ...
            if (categoryDoc) {
                console.log('✅ [PRODUCTS SERVICE] Category found:', {
                    id: categoryDoc.id,
                    slug: category
                });
                ...
                console.warn('⚠️ [PRODUCTS SERVICE] Category not found in any language:', {
                    category,
                    lang
                });
        ...
        return {
            ...
            media: (()=>{
                ...
                if (cleanedMain.length > 0) {
                    console.log('📸 [PRODUCTS SERVICE] Main media (first 3):', cleanedMain.slice(0, 3).map((img)=>img.substring(0, 50)));
                }
                return cleanedMain;
            })(),
            labels: (()=>{
            ...
            productAttributes: Array.isArray(product.productAttributes) ? product.productAttributes.map((pa)=>{
...
"[project]/apps/web/app/api/v1/products/[slug]/reviews/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$lib$2f$services$2f$reviews$2e$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/apps/web/lib/services/reviews.service.ts [app-route] (ecmascript)");
...
async function GET(req, { params }) {
    try {
        ...
        console.log('📝 [REVIEWS API] GET request for product slug:', slug, {
            myReview
        });
        // First, get the product by slug to get the productId
        const product = await __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$lib$2f$services$2f$products$2e$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["productsService"].findBySlug(slug, lang);
        ...
        if (myReview) {
            ...
            const review = await __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$lib$2f$services$2f$reviews$2e$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["reviewsService"].getUserReview(product.id, user.id, true);
        ...
        const reviews = await __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$lib$2f$services$2f$reviews$2e$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["reviewsService"].getProductReviews(product.id, {
            publishedOnly: true
        });
...
async function POST(req, { params }) {
    try {
        ...
        // Create review
        const review = await __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$lib$2f$services$2f$reviews$2e$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["reviewsService"].createReview(product.id, user.id, {
            rating: body.rating,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__125a2c1a._.js.map
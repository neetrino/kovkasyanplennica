...
"[project]/apps/web/app/api/v1/admin/attributes/[id]/translations/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function PATCH(req, { params }) {
    try {
        ...
        console.log('✏️ [ADMIN ATTRIBUTE TRANSLATIONS] PATCH request:', {
            attributeId,
            body
        });
        const result = await __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$lib$2f$services$2f$admin$2e$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["adminService"].updateAttributeTranslation(attributeId, {
            name: body.name,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__2d7533e5._.js.map
...
function useImageHandling({ imageUrls, featuredImageIndex, variants, generatedVariants, colorImageTarget, setImageUrls, setFeaturedImageIndex, setMainProductImage, setVariants, setGeneratedVariants, setImageUploadLoading, setImageUploadError, setColorImageTarget, t }) {
    ...
    const handleUploadColorImages = async (event)=>{
        ...
        if (!files.length || !colorImageTarget) {
            console.log('⚠️ [ADMIN] No files or no color target:', {
...
"[project]/apps/web/app/admin/products/add/hooks/useProductDataLoading.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/apps/web/app/admin/products/add/hooks/useProductEditMode.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
                    ...
                    (product.variants || []).forEach((variant, index)=>{
                        ...
                        if (!color) {
                            ...
                            if (!colorDataMap.has(defaultColor)) {
                                const priceInDefaultCurrency = variant.price !== undefined && variant.price !== null ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$lib$2f$currency$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["convertPrice"])(typeof variant.price === 'number' ? variant.price : parseFloat(String(variant.price || '0')), 'USD', defaultCurrency) : 0;
                                const compareAtPriceInDefaultCurrency = variant.compareAtPrice !== undefined && variant.compareAtPrice !== null ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$lib$2f$currency$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["convertPrice"])(typeof variant.compareAtPrice === 'number' ? variant.compareAtPrice : parseFloat(String(variant.compareAtPrice || '0')), 'USD', defaultCurrency) : 0;
                                const colorData = {
                                ...
                                if (size) {
                                    ...
                                    if (variant.price !== undefined && variant.price !== null) {
                                        const priceInDefaultCurrency = (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$lib$2f$currency$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["convertPrice"])(typeof variant.price === 'number' ? variant.price : parseFloat(String(variant.price || '0')), 'USD', defaultCurrency);
                                    ...
                                    if (variant.compareAtPrice !== undefined && variant.compareAtPrice !== null) {
                                        const compareAtPriceInDefaultCurrency = (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$lib$2f$currency$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["convertPrice"])(typeof variant.compareAtPrice === 'number' ? variant.compareAtPrice : parseFloat(String(variant.compareAtPrice || '0')), 'USD', defaultCurrency);
...
"[project]/apps/web/app/admin/products/add/hooks/useProductVariantConversion.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/apps/web/app/admin/products/add/hooks/useProductAttributeHandlers.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/apps/web/app/admin/products/add/hooks/useBrandAndCategoryCreation.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/apps/web/app/admin/products/add/hooks/useVariantConversionToFormData.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/apps/web/app/admin/products/add/hooks/useVariantValidation.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/apps/web/app/admin/products/add/hooks/useImageProcessingForSubmit.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function processImagesForSubmit({ imageUrls, featuredImageIndex, mainProductImage, variants }) {
    ...
    const mainImage = imageUrls.length > 0 && mainImageMapping.length > featuredImageIndex ? mainImageMapping[featuredImageIndex] : mainImageMapping.length > 0 ? mainImageMapping[0] : mainProductImage;
    return {
        finalMedia,
        mainImage,
        processedVariants
...
"[project]/apps/web/app/admin/products/add/hooks/useProductPayloadCreation.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";

__turbopack_context__.s([
    "createAndSubmitPayload",
    ()=>createAndSubmitPayload
]);
var __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$lib$2f$api$2d$client$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/apps/web/lib/api-client.ts [app-ssr] (ecmascript)");
;
async function createAndSubmitPayload({ formData, finalBrandIds, finalPrimaryCategoryId, variants, attributeIds, finalMedia, mainImage, isEditMode, productId, creationMessages, setLoading, router }) {
    const payload = {
...
"[project]/apps/web/app/admin/products/add/hooks/useProductFormHandlers.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/navigation.js [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$lib$2f$currency$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/apps/web/lib/currency.ts [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$app$2f$admin$2f$products$2f$add$2f$hooks$2f$useBrandAndCategoryCreation$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/apps/web/app/admin/products/add/hooks/useBrandAndCategoryCreation.ts [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$app$2f$admin$2f$products$2f$add$2f$hooks$2f$useVariantConversionToFormData$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/apps/web/app/admin/products/add/hooks/useVariantConversionToFormData.ts [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$app$2f$admin$2f$products$2f$add$2f$hooks$2f$useVariantValidation$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/apps/web/app/admin/products/add/hooks/useVariantValidation.ts [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$app$2f$admin$2f$products$2f$add$2f$hooks$2f$useImageProcessingForSubmit$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/apps/web/app/admin/products/add/hooks/useImageProcessingForSubmit.ts [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$app$2f$admin$2f$products$2f$add$2f$hooks$2f$useProductPayloadCreation$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/apps/web/app/admin/products/add/hooks/useProductPayloadCreation.ts [app-ssr] (ecmascript)");
;
;
;
;
...
function useProductFormHandlers({ formData, setFormData, setLoading, setBrands, setCategories, productType, simpleProductData, selectedAttributesForVariants, generatedVariants, attributes, defaultCurrency, useNewBrand, newBrandName, useNewCategory, newCategoryName, isEditMode, productId, getColorAttribute, getSizeAttribute, isClothingCategory }) {
    const router = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useRouter"])();
    const { createBrandAndCategory } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$app$2f$admin$2f$products$2f$add$2f$hooks$2f$useBrandAndCategoryCreation$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useBrandAndCategoryCreation"])({
        formData,
        useNewBrand,
        newBrandName,
        useNewCategory,
    ...
    const { convertGeneratedVariantsToFormData } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$app$2f$admin$2f$products$2f$add$2f$hooks$2f$useVariantConversionToFormData$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useVariantConversionToFormData"])({
        productType,
        selectedAttributesForVariants,
        generatedVariants,
        attributes,
    ...
    const { validateVariants } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$app$2f$admin$2f$products$2f$add$2f$hooks$2f$useVariantValidation$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useVariantValidation"])({
        productType,
    ...
    const handleSubmit = async (e)=>{
        ...
        try {
            ...
            // Process images
            const { finalMedia, mainImage, processedVariants } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$app$2f$admin$2f$products$2f$add$2f$hooks$2f$useImageProcessingForSubmit$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["processImagesForSubmit"])({
            ...
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$app$2f$admin$2f$products$2f$add$2f$hooks$2f$useProductPayloadCreation$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["createAndSubmitPayload"])({
...
var __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$app$2f$admin$2f$products$2f$add$2f$hooks$2f$useProductDataLoading$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/apps/web/app/admin/products/add/hooks/useProductDataLoading.ts [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$app$2f$admin$2f$products$2f$add$2f$hooks$2f$useProductEditMode$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/apps/web/app/admin/products/add/hooks/useProductEditMode.tsx [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$app$2f$admin$2f$products$2f$add$2f$hooks$2f$useProductVariantConversion$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/apps/web/app/admin/products/add/hooks/useProductVariantConversion.tsx [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$app$2f$admin$2f$products$2f$add$2f$hooks$2f$useProductAttributeHandlers$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/apps/web/app/admin/products/add/hooks/useProductAttributeHandlers.ts [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$app$2f$admin$2f$products$2f$add$2f$hooks$2f$useProductFormHandlers$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/apps/web/app/admin/products/add/hooks/useProductFormHandlers.ts [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$app$2f$admin$2f$products$2f$add$2f$utils$2f$productUtils$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/apps/web/app/admin/products/add/utils/productUtils.ts [app-ssr] (ecmascript)");
'use client';
;
;
...
function AddProductPageContent() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$app$2f$admin$2f$products$2f$add$2f$hooks$2f$useProductDataLoading$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useProductDataLoading"])({
        isLoggedIn,
        isAdmin,
        isLoading,
        setBrands,
    ...
    // Use edit mode hook
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$app$2f$admin$2f$products$2f$add$2f$hooks$2f$useProductEditMode$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useProductEditMode"])({
        productId,
        isLoggedIn,
        isAdmin,
        attributes,
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$app$2f$admin$2f$products$2f$add$2f$hooks$2f$useProductVariantConversion$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useProductVariantConversion"])({
        productId,
        attributes,
        defaultCurrency,
        setSelectedAttributesForVariants,
    ...
    const colorAttribute = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useMemo"])(()=>{
        ...
        if (!colorAttr) {
            console.log('⚠️ [ADMIN] Color attribute not found. Available attributes:', attributes.map((a)=>({
                    key: a.key,
                    name: a.name
                })));
        } else {
    ...
    const sizeAttribute = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useMemo"])(()=>{
        ...
        if (!sizeAttr) {
            console.log('⚠️ [ADMIN] Size attribute not found. Available attributes:', attributes.map((a)=>({
                    key: a.key,
                    name: a.name
                })));
        } else {
    ...
    const attributeHandlers = (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$app$2f$admin$2f$products$2f$add$2f$hooks$2f$useProductAttributeHandlers$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useProductAttributeHandlers"])({
        attributes,
        setAttributes,
        getColorAttribute,
        getSizeAttribute
    ...
    const { handleSubmit } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$app$2f$admin$2f$products$2f$add$2f$hooks$2f$useProductFormHandlers$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useProductFormHandlers"])({
        formData,
        setFormData,
        setLoading,
        setBrands,
...
//# sourceMappingURL=_6dc22f20._.js.map
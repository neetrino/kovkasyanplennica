...
"[project]/apps/web/app/api/v1/admin/attributes/[id]/values/[valueId]/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function PATCH(req, { params }) {
    try {
        ...
        console.log('✏️ [ADMIN ATTRIBUTE VALUES] PATCH request:', {
            attributeId,
            valueId,
            body
        });
        const result = await __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$lib$2f$services$2f$admin$2e$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["adminService"].updateAttributeValue(attributeId, valueId, {
            label: body.label,
            colors: body.colors,
...
async function DELETE(req, { params }) {
    try {
        ...
        const result = await __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$lib$2f$services$2f$admin$2e$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["adminService"].deleteAttributeValue(valueId);
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            data: result
        }, {
            status: 200
...
//# sourceMappingURL=%5Broot-of-the-server%5D__23705186._.js.map
...
"[project]/apps/web/app/api/v1/admin/products/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
 ...
 */ function validateAndNormalizeFilters(searchParams) {
    // Валидация page
...
async function GET(req) {
    ...
    try {
        ...
        if (!user || !(0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$lib$2f$middleware$2f$auth$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["requireAdmin"])(user)) {
            console.warn("⚠️ [ADMIN PRODUCTS API] Unauthorized access attempt", {
                userId: user?.id
            });
        ...
        if (validationResult.error) {
            ...
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(validationResult.error, {
        ...
        const result = await __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$lib$2f$services$2f$admin$2e$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["adminService"].getProducts(filters);
...
async function POST(req) {
    const requestStartTime = Date.now();
    console.log("📤 [ADMIN PRODUCTS API] POST request received", {
        url: req.url
    });
    try {
        // Аутентификация и проверка прав администратора
        const user = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$lib$2f$middleware$2f$auth$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["authenticateToken"])(req);
        if (!user || !(0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$lib$2f$middleware$2f$auth$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["requireAdmin"])(user)) {
            console.warn("⚠️ [ADMIN PRODUCTS API] Unauthorized POST attempt", {
                userId: user?.id
            });
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                type: "https://api.shop.am/problems/forbidden",
        ...
        const serviceStartTime = Date.now();
        const product = await __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$lib$2f$services$2f$admin$2e$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["adminService"].createProduct(body);
        const serviceTime = Date.now() - serviceStartTime;
        const totalTime = Date.now() - requestStartTime;
...
//# sourceMappingURL=%5Broot-of-the-server%5D__805a27e8._.js.map
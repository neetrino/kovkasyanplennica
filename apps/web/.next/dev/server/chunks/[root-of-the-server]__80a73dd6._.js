...
"[project]/apps/web/app/api/v1/admin/settings/price-filter/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(req) {
    try {
        ...
        const result = await __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$lib$2f$services$2f$admin$2e$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["adminService"].getPriceFilterSettings();
...
async function PUT(req) {
    try {
        ...
        if (data.minPrice !== null && data.minPrice !== undefined && data.maxPrice !== null && data.maxPrice !== undefined && data.minPrice >= data.maxPrice) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                type: "https://api.shop.am/problems/validation-error",
                title: "Validation Error",
                status: 400,
        ...
        const result = await __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$lib$2f$services$2f$admin$2e$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["adminService"].updatePriceFilterSettings(data);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__80a73dd6._.js.map
...
function AddProductPageContent() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "AddProductPageContent.useEffect": ()=>{
            if (!isLoading) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "AddProductPageContent.useEffect": ()=>{
            const loadDefaultCurrency = {
                "AddProductPageContent.useEffect.loadDefaultCurrency": async ()=>{
                    try {
            ...
            }["AddProductPageContent.useEffect.loadDefaultCurrency"];
            if (isLoggedIn && isAdmin) {
                loadDefaultCurrency();
            }
        }
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "AddProductPageContent.useEffect": ()=>{
            const fetchData = {
                "AddProductPageContent.useEffect.fetchData": async ()=>{
                    try {
                        ...
                        if (attributesRes.data && attributesRes.data.length > 0) {
                            console.log('📋 [ADMIN] Attributes loaded:', attributesRes.data.map({
                                "AddProductPageContent.useEffect.fetchData": (attr)=>({
                                        id: attr.id,
                                        key: attr.key,
                                        name: attr.name,
                                        valuesCount: attr.values?.length || 0,
                                        values: attr.values?.map({
                                            "AddProductPageContent.useEffect.fetchData": (v)=>({
                                                    value: v.value,
                                                    label: v.label,
                                                    colors: v.colors,
                                        ...
                                        }["AddProductPageContent.useEffect.fetchData"]) || []
                                    })
                            }["AddProductPageContent.useEffect.fetchData"]));
                            const colorAttr = attributesRes.data.find({
                                "AddProductPageContent.useEffect.fetchData.colorAttr": (a)=>a.key === 'color'
                            }["AddProductPageContent.useEffect.fetchData.colorAttr"]);
                            const sizeAttr = attributesRes.data.find({
                                "AddProductPageContent.useEffect.fetchData.sizeAttr": (a)=>a.key === 'size'
                            }["AddProductPageContent.useEffect.fetchData.sizeAttr"]);
                            if (!colorAttr) {
                        ...
                        if (categoriesRes.data) {
                            console.log('📋 [ADMIN] Categories with requiresSizes:', categoriesRes.data.map({
                                "AddProductPageContent.useEffect.fetchData": (cat)=>({
                                        id: cat.id,
                                        title: cat.title,
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "AddProductPageContent.useEffect": ()=>{
            if (productId && isLoggedIn && isAdmin) {
                const loadProduct = {
                    "AddProductPageContent.useEffect.loadProduct": async ()=>{
                        try {
                            ...
                            (product.variants || []).forEach({
                                "AddProductPageContent.useEffect.loadProduct": (variant, index)=>{
                                    ...
                                    if (!color && variant.options && Array.isArray(variant.options)) {
                                        ...
                                        const colorOption = variant.options.find({
                                            "AddProductPageContent.useEffect.loadProduct.colorOption": (opt)=>{
                                        ...
                                        }["AddProductPageContent.useEffect.loadProduct.colorOption"]);
                                        if (colorOption) {
                                            ...
                                            const colorOptionByValue = variant.options.find({
                                                "AddProductPageContent.useEffect.loadProduct.colorOptionByValue": (opt)=>{
                                            ...
                                            }["AddProductPageContent.useEffect.loadProduct.colorOptionByValue"]);
                                    ...
                                    if (!size && variant.options && Array.isArray(variant.options)) {
                                        ...
                                        const sizeOption = variant.options.find({
                                            "AddProductPageContent.useEffect.loadProduct.sizeOption": (opt)=>{
                                        ...
                                        }["AddProductPageContent.useEffect.loadProduct.sizeOption"]);
                                        if (sizeOption) {
                                            ...
                                            const sizeOptionByValue = variant.options.find({
                                                "AddProductPageContent.useEffect.loadProduct.sizeOptionByValue": (opt)=>{
                                            ...
                                            }["AddProductPageContent.useEffect.loadProduct.sizeOptionByValue"]);
                                    ...
                                    if (!color) {
                                        ...
                                        if (!colorDataMap.has(defaultColor)) {
                                            ...
                                            const compareAtPriceInDefaultCurrency = variant.compareAtPrice !== undefined && variant.compareAtPrice !== null ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$lib$2f$currency$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["convertPrice"])(variant.compareAtPrice, 'USD', defaultCurrency) : 0;
                                            const colorData = {
                                            ...
                                            if (variant.imageUrl) {
                                                ...
                                                imageUrls.forEach({
                                                    "AddProductPageContent.useEffect.loadProduct": (url)=>{
                                                        const exists = existingColorData.images.some({
                                                            "AddProductPageContent.useEffect.loadProduct.exists": (existingUrl)=>{
                                                        ...
                                                        }["AddProductPageContent.useEffect.loadProduct.exists"]);
                                                        if (url && !exists) {
                                                            existingColorData.images.push(url);
                                                        }
                                                    }
                                                }["AddProductPageContent.useEffect.loadProduct"]);
                                            }
                                            if (size) {
                                                ...
                                                if (variant.price !== undefined && variant.price !== null) {
                                                    const priceInDefaultCurrency = (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$lib$2f$currency$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["convertPrice"])(variant.price, 'USD', defaultCurrency);
                                                ...
                                                if (variant.compareAtPrice !== undefined && variant.compareAtPrice !== null) {
                                                    const compareAtPriceInDefaultCurrency = (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$lib$2f$currency$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["convertPrice"])(variant.compareAtPrice, 'USD', defaultCurrency);
                                        ...
                                        if (!colorDataMap.has(color)) {
                                            ...
                                            const colorAttribute = attributes.find({
                                                "AddProductPageContent.useEffect.loadProduct.colorAttribute": (attr)=>attr.key === 'color'
                                            }["AddProductPageContent.useEffect.loadProduct.colorAttribute"]);
                                            const colorValueObj = colorAttribute?.values.find({
                                                "AddProductPageContent.useEffect.loadProduct": (v)=>v.value === color
                                            }["AddProductPageContent.useEffect.loadProduct"]);
                            ...
                            mergedVariant.colors.forEach({
                                "AddProductPageContent.useEffect.loadProduct": (c)=>{
                                    c.images.forEach({
                                        "AddProductPageContent.useEffect.loadProduct": (img)=>{
                                            if (img) {
                            ...
                            (product.variants || []).forEach({
                                "AddProductPageContent.useEffect.loadProduct": (variant, idx)=>{
                                    if (variant.imageUrl) {
                                        ...
                                        if (typeof variant.imageUrl === 'string' && variant.imageUrl.startsWith('data:')) {
                                            ...
                                            const imageUrls = typeof variant.imageUrl === 'string' ? variant.imageUrl.split(',').map({
                                                "AddProductPageContent.useEffect.loadProduct": (url)=>url.trim()
                                            }["AddProductPageContent.useEffect.loadProduct"]).filter(Boolean) : [];
                                            imageUrls.forEach({
                                                "AddProductPageContent.useEffect.loadProduct": (url)=>{
                                                    if (url) {
                            ...
                            const normalizeUrlForComparison = {
                                "AddProductPageContent.useEffect.loadProduct.normalizeUrlForComparison": (url)=>{
                                    if (!url) return [];
                            ...
                            }["AddProductPageContent.useEffect.loadProduct.normalizeUrlForComparison"];
                            ...
                            setFormData({
                                ...
                                labels: (product.labels || []).map({
                                    "AddProductPageContent.useEffect.loadProduct": (label)=>({
                                            id: label.id || '',
                            ...
                            const hasVariantsWithAttributes = hasVariants && variants.some({
                                "AddProductPageContent.useEffect.loadProduct": (variant)=>{
        ...
        "AddProductPageContent.useEffect": ()=>{
            if (productId && attributes.length > 0 && window.__productVariantsToConvert) {
                ...
                productVariants.forEach({
                    "AddProductPageContent.useEffect": (variant)=>{
                        if (variant.options && Array.isArray(variant.options)) {
                            variant.options.forEach({
                                "AddProductPageContent.useEffect": (opt)=>{
                ...
                if (productAttributeIds.length > 0) {
                    ...
                    productAttributeIds.forEach({
                        "AddProductPageContent.useEffect": (attrId)=>{
                ...
                productVariants.forEach({
                    "AddProductPageContent.useEffect": (variant, variantIndex)=>{
                        ...
                        if (variant.attributes && typeof variant.attributes === 'object') {
                            ...
                            Object.keys(variant.attributes).forEach({
                                "AddProductPageContent.useEffect": (attributeKey)=>{
                                    const attribute = attributes.find({
                                        "AddProductPageContent.useEffect.attribute": (a)=>a.key === attributeKey
                                    }["AddProductPageContent.useEffect.attribute"]);
                                    if (!attribute) {
                                    ...
                                    if (Array.isArray(attributeValues)) {
                                        attributeValues.forEach({
                                            "AddProductPageContent.useEffect": (attrValue)=>{
                                                ...
                                                if (valueId) {
                                                    ...
                                                    const foundValue = attribute.values.find({
                                                        "AddProductPageContent.useEffect.foundValue": (v)=>v.value === value || v.label === value
                                                    }["AddProductPageContent.useEffect.foundValue"]);
                        ...
                        if (selectedValueIds.length === 0 && variant.options && Array.isArray(variant.options)) {
                                ...
                                "AddProductPageContent.useEffect": (opt)=>{
                                    ...
                                    if (!attributeId && opt.attributeKey) {
                                        const foundAttr = attributes.find({
                                            "AddProductPageContent.useEffect.foundAttr": (a)=>a.key === opt.attributeKey
                                        }["AddProductPageContent.useEffect.foundAttr"]);
                                        if (foundAttr) {
                                    ...
                                    if (attributeId && !valueId && opt.value) {
                                        const foundAttr = attributes.find({
                                            "AddProductPageContent.useEffect.foundAttr": (a)=>a.id === attributeId
                                        }["AddProductPageContent.useEffect.foundAttr"]);
                                        if (foundAttr) {
                                            const foundValue = foundAttr.values.find({
                                                "AddProductPageContent.useEffect.foundValue": (v)=>v.value === opt.value || v.label === opt.value
                                            }["AddProductPageContent.useEffect.foundValue"]);
                                            if (foundValue) {
                            ...
                            Object.values(attributeValueMap).forEach({
                                "AddProductPageContent.useEffect": (valueIdSet)=>{
                                    valueIdSet.forEach({
                                        "AddProductPageContent.useEffect": (valueId)=>{
                                            if (!selectedValueIds.includes(valueId)) {
                                                selectedValueIds.push(valueId);
                                            }
                                        }
                        ...
                        if (variant.imageUrl) {
                            ...
                            if (typeof variant.imageUrl === 'string' && variant.imageUrl.startsWith('data:')) {
                                ...
                                // Regular URL - can be comma-separated
                                const imageUrls = typeof variant.imageUrl === 'string' ? variant.imageUrl.split(',').map({
                                    "AddProductPageContent.useEffect": (url)=>url.trim()
                                }["AddProductPageContent.useEffect"]).filter(Boolean) : [];
                ...
                variantDataList.forEach({
                    "AddProductPageContent.useEffect": (variantData)=>{
                ...
                variantGroups.forEach({
                    "AddProductPageContent.useEffect": (group, groupKey)=>{
                        ...
                        const allStocksSame = group.every({
                            "AddProductPageContent.useEffect.allStocksSame": (v)=>v.stock === firstVariant.stock
                        }["AddProductPageContent.useEffect.allStocksSame"]);
                        ...
                        const combinedSku = group.length === 1 ? firstVariant.sku : group.map({
                            "AddProductPageContent.useEffect": (v)=>v.sku
                        }["AddProductPageContent.useEffect"]).filter(Boolean).join(', ');
                        ...
                        console.log(`✅ [ADMIN] Grouped ${group.length} variants into 1 row:`, {
                            ...
                            originalVariantIds: group.flatMap({
                                "AddProductPageContent.useEffect": (v)=>v.originalVariantIds
                            }["AddProductPageContent.useEffect"])
                        });
                    }
                }["AddProductPageContent.useEffect"]);
                if (convertedVariants.length > 0) {
                    ...
                    console.log('✅ [ADMIN] Converted product variants to generatedVariants:', {
                        ...
                        convertedVariants: convertedVariants.map({
                            "AddProductPageContent.useEffect": (v)=>({
                                    id: v.id,
    ...
    const colorAttribute = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "AddProductPageContent.useMemo[colorAttribute]": ()=>{
            ...
            if (!colorAttr) {
                console.log('⚠️ [ADMIN] Color attribute not found. Available attributes:', attributes.map({
    ...
    const sizeAttribute = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "AddProductPageContent.useMemo[sizeAttribute]": ()=>{
            ...
            if (!sizeAttr) {
                console.log('⚠️ [ADMIN] Size attribute not found. Available attributes:', attributes.map({
    ...
    const handleSubmit = async (e)=>{
        ...
        try {
                        ...
                        if (colorDataArray.length > 0) {
                            colorDataArray.forEach((colorData, colorIndex)=>{
                                ...
                                if (colorSizes.length > 0) {
                                    colorSizes.forEach((size, sizeIndex)=>{
                                        ...
                                        const finalCompareAtPrice = finalCompareAtPriceRaw ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$lib$2f$currency$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["convertPrice"])(finalCompareAtPriceRaw, defaultCurrency, 'USD') : undefined;
                            ...
                            if (variantSizes.length > 0) {
                                variantSizes.forEach((size, sizeIndex)=>{
                                    ...
                                    // Convert prices from defaultCurrency to USD
                                    const finalPrice = (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$lib$2f$currency$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["convertPrice"])(baseVariantData.price, defaultCurrency, 'USD');
                                    const finalCompareAtPrice = baseVariantData.compareAtPrice ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$lib$2f$currency$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["convertPrice"])(baseVariantData.compareAtPrice, defaultCurrency, 'USD') : undefined;
                                    // Collect all attribute options for this variant
                                    const variantOptions = [];
                                    // Add size option
                                    if (size && size.trim() !== '') {
            ...
            if (isEditMode && productId) {
                ...
                const product = await __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$lib$2f$api$2d$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiClient"].put(`/api/v1/admin/products/${productId}`, payload);
                ...
                // Create new product
                const product = await __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$lib$2f$api$2d$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiClient"].post('/api/v1/admin/products', payload);
...
_s(AddProductPageContent, "37t9NoZQ6zyGv6iaJDrpJO4+y58=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$lib$2f$i18n$2d$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useTranslation"],
...
//# sourceMappingURL=_1b41db57._.js.map
...
import type { CreateSpinWheelPrizeInput } from "@/lib/services/spin-wheel/spin-wheel.types";
...
export async function GET(req: NextRequest) {
  try {
    ...
    const result = await spinWheelService.getAdminPrizes();
...
export async function POST(req: NextRequest) {
  try {
    ...
    const body = (await req.json()) as CreateSpinWheelPrizeInput;
    const result = await spinWheelService.createPrize(body);

...
export function ProductCardActions({
  ...
  // For Figma design: only show cart button in bottom actions (not wishlist/compare)
  // Bottom cart button - Figma design: green circular button with white cart icon
  return (
    <button
      onClick={onAddToCart}
      disabled={!inStock || isAddingToCart}
      className="w-[58px] h-[58px] rounded-full bg-[#87CB6F] flex items-center justify-center transition-all duration-200 hover:bg-[#7ab85f] disabled:bg-gray-300 disabled:cursor-not-allowed shadow-md"

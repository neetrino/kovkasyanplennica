      ...
      <div className="relative z-[1] pointer-events-none text-inherit">
        <div className="relative mb-4 flex h-32 w-full items-center justify-center overflow-hidden rounded-2xl bg-[#f1f5f5]">
          {imageSrc ? (
            ...
            <div className="flex h-full w-full items-center justify-center bg-[#eef1f3]" aria-hidden>
        ...
        <div className="flex items-center justify-between gap-2">
          ...
          <span className="pointer-events-auto relative z-[2] shrink-0">
            <button
              type="button"
              onClick={handleAddToCart}
              disabled={!inStock || isAddingToCart}
              className="flex h-9 w-9 items-center justify-center rounded-full bg-[#87CB6F] shadow-md transition-colors hover:bg-[#7ab85f] disabled:cursor-not-allowed disabled:bg-gray-300"
